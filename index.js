...
function calculateExpression(expression) {
  if(isNaN(expression)){//Преревіряємо чи аргумент є рядком
...
function getNumberFromString(s) {
  let arg=parseFloat(s);// Використовуємо функцію parseFloat для того, щоб спробувати отримати число з рядка
  if(isNaN(arg)){return "Couldn't extract a number from the provided string."}// Перевіряємо, чи є отримане значення числом за допомогою isNaN
  else{return arg;}// Якщо значення не є числом, повертаємо текст "Couldn't extract a number from the provided string."
...
function getIntegerFromString(s) {
 // Використовуємо функцію parseInt для того, щоб спробувати отримати ціле число з рядка
  if(isNaN(parseInt(s))){return "Couldn't extract a number from the provided string."}// Перевіряємо, чи є отримане значення числом за допомогою isNaN
  else{return parseInt(s) }// Якщо значення не є числом, повертаємо текст "Couldn't extract an integer from the provided string."
  // Якщо значення є числом, повертаємо його
}
...
function isNumberFinite(num) {
  ...
  return "The number is finite.";}// Ця функція повертає true, якщо число є скінченним, і false, якщо число є нескінченним або не є числом.
  else{return "The number is not finite."}// За допомогою оператора if перевіряємо, чи є число скінченним.
...
function isValueNaN(value) {
  ...
  {return "The value is NaN."}// Ця функція повертає true, якщо значення є NaN, і false, якщо значення не є NaN.
  else{return "The value is not NaN."}// За допомогою оператора if перевіряємо, чи є значення NaN.
...
function createURLObject(urlStr) {
 return encodeURL(urlStr)// Використовуємо вбудований конструктор URL, щоб створити новий об'єкт URL з введеного рядка.
